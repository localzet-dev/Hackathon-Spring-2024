function api_main_user_get_info(){
	...
	axios.get('https://oggetto-coffee.localzet.com/api/user')
		.then(function (response) {
            ...
            if (!!user.img_url) {
                document.getElementById('ui_main_user_img_url').src = user.img_url;
            } else {
            ...
            if (ev){
                ...
                <div class="alert alert-custom alert-indicator-top indicator-success" role="alert">
                    <div class="alert-content">
                        <span class="alert-title">На этой недели у вас встреча с `+window.friend['firstname']+` `+window.friend['lastname']+`</span>
                        <span class="alert-text"`+window.friend['about']+`></span>
                    </div>
                </div>
                <div class="card">
                    <div class="card-body">
